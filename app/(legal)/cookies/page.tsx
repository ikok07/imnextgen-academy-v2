...
export default function CookiesPage() {
    return <>
        ...
        <p>
            <strong>Платформата не поставя рекламни бисквитки и не ползва инструменти за
            проследяване или анализ на поведението.</strong> Затова няма и банер за съгласие —
            за бисквитките по-долу такова не се изисква.
        </p>
