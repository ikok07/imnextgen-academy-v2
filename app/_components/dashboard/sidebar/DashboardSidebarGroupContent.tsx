...
export default function DashboardSidebarGroupContent({group, isLoading}: DashboardSidebarNavLinkContentProps) {
    ...
    return <>
        {group.items.map((item, index) => {
            ...
            if (isLoading) return <SidebarMenuSkeleton showIcon={true} />
