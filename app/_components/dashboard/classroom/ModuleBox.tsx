...
export default function ModuleBox({module, moduleAllowed}: ModuleBoxProps) {
    ...
    return <div className="rounded-lg shadow-xl border border-border w-[95%] md:w-full mx-auto">
        ...
        {module.image_url && <div className="relative w-full aspect-video overflow-hidden"><img alt={module.title} src={module.image_url} className="absolute inset-0 rounded-t-lg"/></div>}
