...
import {VideoProgressesInsert, videoProgressesSchema} from "@/drizzle/schema/video_progresses";
...
export const setVideoProgressController = (
    ...
    const {data: parsedDate, error} = videoProgressesSchema.safeParse(data);
